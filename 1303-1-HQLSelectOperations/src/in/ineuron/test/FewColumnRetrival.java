...
public class FewColumnRetrival {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			Query<Object[]> query = session.createQuery("select prodName,prodPrice FROM in.ineuron.model.Product WHERE prodName IN(:key1,:key2)");
