...
public class UpdateArow {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			Query query = session.createQuery("UPDATE in.ineuron.model.Product SET prodQty=prodQty+:addqty WHERE prodName LIKE :prodName");
			
			query.setParameter("addqty", 3000);
			query.setParameter("prodName", "o%");
