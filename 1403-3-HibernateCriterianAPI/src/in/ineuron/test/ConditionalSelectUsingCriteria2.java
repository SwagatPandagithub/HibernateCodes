...
public class ConditionalSelectUsingCriteria2 {
	...
	try {
		...
		criteria.add(cond1);
		criteria.add(cond2);//HQL-->from in.ineuron.product where prodprice>100 and prodPrice<1000 orderby ascending(prodNamme)
